"""
This file is the entire program--front end connected to backend, all logic and templates in place. However, it does not
currently run. We've had issues with Python folder structure--we'd been attempting to contain all form-specific
information (i.e. BioSolids code, templates, and related crops from uploaded form) in one folder to avoid having
200+ files in the main Scripts folder, but we couldn't figure out how to do that. Therefore, this code is not
currently operational.

If you'd like to ensure that the GUI itself can run and all screens are in order (for testing purposes), please use the
'framedesignwplaceholderocr' file.
"""
